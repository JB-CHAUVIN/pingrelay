...
const config = {
  ...
  appDescription:
    "Automatisez vos messages WhatsApp pour webinaires. Envoyez des rappels, engagez vos participants et fidélisez votre audience avant, pendant et après vos événements en ligne.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "pingrelay.live",
  crisp: {
    ...
    plans: [
      {
        ...
        priceId:
          process.env.NODE_ENV === "development"
            ? "price_1SxmD6IA3FdrbelqLz4oZhsA"
            : "price_1SxmU7I4zii1NCoojQfFyfkX",
        //  REQUIRED - Name of the plan, displayed on the pricing page
        name: "Starter",
        // A friendly description of the plan, displayed on the pricing page. Tip: explain why this plan and not others
        description: "Parfait pour vos premiers webinaires",
      ...
      },
      {
        priceId:
          process.env.NODE_ENV === "development"
            ? "price_1SxmDSIA3FdrbelqblMvUapK"
            : "price_1SxmUiI4zii1NCooBTZDmmbj",
        ...
        features: [
          ...
          { name: "Messages automatisés illimités" },
          { name: "Modèles de messages illimités" },
  ...
  resend: {
    ...
    fromNoReply: `PingRelay <noreply@resend.pingrelay.live>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `PingRelay <marc@resend.pingrelay.live>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "chauvin.jbaptiste@mgail.com",
  },
  colors: {
