      ...
      <>
        <ul className="space-y-1">
          {[
            ...
            "Envoi automatique avant, pendant et après",
            "Personnalisation avec variables (prénom, date, etc.)",
          ].map((item) => (
