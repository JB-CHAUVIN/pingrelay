...
export default function PhonesPage() {
  ...
  const handleConnectionSuccess = () => {
    ...
    toast.success(dict.phones.connectionSuccess);
  };
  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto max-w-7xl">
        <div className="bg-base-100 rounded-lg shadow-lg p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-3xl font-bold">{dict.phones.pageTitle}</h1>
              <p className="text-base-content/60 mt-1">
                {dict.phones.pageDescription}
              </p>
            </div>
      ...
      <DeleteConfirmModal
        ...
        title={dict.phones.deleteConfirmTitle}
        message={dict.phones.deleteConfirmMessage}
      />
    </div>
  );
}
